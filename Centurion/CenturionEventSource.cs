...
namespace Centurion
{
    ...
    {
        public CenturionEventSourceConfig Config { get; private set; }
        ...
        public CenturionEventSource(TinyIoCContainer container) : base(container)
        {
            ...
            {
                "onCenturionOriginalTimerFiredEvent", "onCenturionEmbeddedTimerFiredEvent",
            });
        ...
        {
            return new CenturionEventSourceConfigPanel(this);
        }

        public override void LoadConfig(IPluginConfig config)
        {
            Config = CenturionEventSourceConfig.LoadConfig(config);
        }
        ...
        public override void Start()
        {
            ...
            originalTimer.Elapsed += (obj, args) =>
            {
                ...
                {
                    type = "onCenturionOriginalTimerFiredEvent",
        ...
        protected override void Update()
        {
            DispatchEvent(JObject.FromObject(new
            {
                type = "onCenturionEmbeddedTimerFiredEvent",
    ...
    public class JSEvents
    {
        public class OriginalTimerFiredEvent : JSEvent
        {
            ...
            public string EventName() { return "onCenturionOriginalTimerFiredEvent"; }
        }
        ...
        public class EmbeddedTimerFiredEvent : JSEvent
        {
            ...
            public string EventName() { return "onCenturionEmbeddedTimerFiredEvent"; }
        }
    }
}
